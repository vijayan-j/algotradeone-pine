...
3. Replace the placeholder EMA-cross signal block with the five-leg confluence
   model from `docs/confluence-logic.md`. Legs are defined inline — the canonical
   indicator is self-contained, with no library dependency.
